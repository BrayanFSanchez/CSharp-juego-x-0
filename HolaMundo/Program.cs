    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                //Código que verifica si hay ganador
                #region
                char[] cadaSigno = { 'X', 'O' };
                foreach (char signo in cadaSigno)
                {
                    ...
                    {
                        if (signo == 'X') Console.WriteLine("Fecitaciones. Ha ganado el jugador 2!");
                        else
                            Console.WriteLine("Fecitaciones. Ha ganado el jugador 1!");
                ...
                // Código que verifica si el valor ingresadp el válido
                #region
                do
                {
        ...
        public static void PonerXo0(int jugador, int ingreso)
        {
            char signo = ' ';
            ...
            {
                case 1:
                    tableroJuego[0, 0] = signo;
                    break;

                case 2:
                    tableroJuego[0, 1] = signo;
                    break;

                case 3:
                    tableroJuego[0, 2] = signo;
                    break;

                case 4:
                    tableroJuego[1, 0] = signo;
                    break;

                case 5:
                    tableroJuego[1, 1] = signo;
                    break;

                case 6:
                    tableroJuego[1, 2] = signo;
                    break;

                case 7:
                    tableroJuego[2, 0] = signo;
                    break;

                case 8:
                    tableroJuego[2, 1] = signo;
                    break;

                case 9:
                    tableroJuego[2, 2] = signo;
                    break;
            }
        }
